...
*   **STRIDE Wizard**: Select any canvas component to receive structured threat suggestions categorized by the classic **STRIDE** methodology:
    *   **S**poofing
    *   **T**ampering
    *   **R**epudiation
...
2.  Open [threat-tiger.html](file:///c:/Users/johan/Desktop/Threat-tiger/threat-tiger.html) in any modern web browser (Chrome, Firefox, Edge, Safari).
...
5.  Use the **STRIDE Wizard** on selected components to identify security risks and append them to your **Active Threat Register**.
...
This project is licensed under the MIT License. See [threat-tiger.html](file:///c:/Users/johan/Desktop/Threat-tiger/threat-tiger.html) for full license details.
